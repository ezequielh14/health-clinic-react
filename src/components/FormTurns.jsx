...
const FormTurns = () => {
    ...
    return (
        <>
            <div className="grid min-h-screen w-screen grid-cols-2 items-center justify-center bg-gray-50 dark:bg-gray-900">
                <div className="col-span-2 mx-auto w-full rounded-lg bg-white p-6 shadow dark:bg-gray-800 md:w-1/2">
                ...
                <div className="col-span-2 mx-auto w-full md:w-[80%]">
